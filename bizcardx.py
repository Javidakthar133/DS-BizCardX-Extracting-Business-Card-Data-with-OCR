...
background_image_url = "https://img.freepik.com/premium-photo/high-quality-nature-background-landscape-background-hd-nature-landscape-images-highresolu_881299-93181.jpg"  
...
# Title for the app
st.markdown("<h1 style='text-align:center;text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); color:#456480; font-size:50px;'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)
...
if selected == "Contact":
    ...
    social_media = {
        ...
        "LINKEDIN": "https://www.linkedin.com/in/javid-akthar-928295276/"
    }
    ...
    with col2:
        st.markdown("<h1 style='color:#456480; font-size:50px;text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)
        st.write("""
